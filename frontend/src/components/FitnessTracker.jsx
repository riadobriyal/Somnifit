...
function FitnessTracker() {
  ...
  const exercise_plans = [
    "Introductory Light Activity",
    "Ideal for beginners or individuals with higher body fat percentages. Focuses on gentle cardio like walking, stationary cycling or light swimming (30 minutes, 3–4× per week), combined with basic mobility and stretching. This plan emphasizes building consistency, improving joint flexibility, and kick‑starting metabolism with minimal strain.",
    "Foundational Conditioning",
    "Still beginner‑focused but with slightly increased intensity. Includes moderate walking/jogging intervals (20/10 min mix), simple body‑weight exercises like squats, wall push‑ups, and hip bridges, 3–4× per week. Targets improved muscular endurance and steady-state fat burn, laying a foundation for more complex routines later.",
    "Strength & Moderate Cardio Blend",
    "A balanced plan combining resistance and cardio. Structured around 3 full-body strength sessions per week (e.g., lunges, push-ups, rows using light dumbbells or bands) plus 2 days of moderate cardio (30–40 minutes). Adds core stability drills and dynamic stretches. Builds muscular strength while maintaining cardiovascular gains.",
    "Frequency & Volume Increase",
    "For those with some baseline fitness and moderate BMI/BFP. Training rises to 5–6 days per week: 4 days of split resistance training (upper/lower body alternated) with moderate weights for 3–4 sets of 8–12 reps, plus 1–2 dedicated cardio or HIIT sessions (20–25 minutes). Includes active recovery and mobility work to boost performance and recovery.",
    "Targeted Fat-Loss Emphasis",
    "Designed to optimize fat reduction. Strength workouts continue 4× weekly focusing on compound movements, paired with 3 HIIT sessions (15–20 minutes) or moderate steady-state cardio (45–60 minutes). Nutrition advice typically complements training: calorie deficit, high-quality protein intake, and recovery monitoring to prevent overtraining.",
    "Hypertrophy & Muscle Toning",
    "Aimed at building lean muscle and definition. Resistance training 5 days a week targeting specific muscle groups (e.g., chest/back/arms/legs/core) with moderate‑heavy loads for 3–5 sets of 8–15 reps. Two weekly cardio/conditioning sessions maintain cardiovascular health. Mobility, foam rolling, and flexibility work are built in to enhance performance and reduce injury risk.",
    "Advanced Athletic Conditioning",
    "For individuals with lower BMI/BFP and strong fitness foundations. Highly structured plan featuring 5 resistance sessions (with periodized intensity: heavy, moderate, light days), 2 HIIT/cardio sessions, and supplemental agility/power/core drills. Includes advanced techniques (supersets, plyometrics), recovery strategies (sleep tracking, deload cycles), and goal-specific refinements (e.g., endurance, strength, physique).",
  ];
          ...
          <div className="flex-1 flex flex-col items-center justify-center px-4">
            <div className="relative w-full flex flex-col items-center justify-center min-h-[60vh]">
              <div className="absolute inset-0 z-0 pointer-events-none">
                <div
                  className="w-full absolute left-0 top-0 h-[60px] pointer-events-auto"
                  style={{ cursor: "pointer" }}
                />
                <div
                  className="w-full absolute left-0 top-[60px] h-[40px] pointer-events-auto"
                  style={{ cursor: "pointer" }}
                />
                <div
                  className="w-full absolute left-0 top-[160px] h-[30px] pointer-events-auto"
                  style={{ cursor: "pointer" }}
                />
                <div
                  className="w-full absolute left-0 top-[220px] h-[40px] pointer-events-auto"
                  style={{ cursor: "pointer" }}
                />
                <div
                  className="w-full absolute left-0 top-[320px] h-[60px] pointer-events-auto"
                  style={{ cursor: "pointer" }}
                />
                <div
                  className="absolute top-[60px] bottom-[120px] left-0 w-[10%] pointer-events-auto"
                  style={{ cursor: "pointer" }}
                />
                <div
                  className="absolute top-[60px] bottom-[120px] right-0 w-[10%] pointer-events-auto"
                  style={{ cursor: "pointer" }}
                />
              </div>
              <div className="relative z-10 flex flex-col items-center justify-center w-full">
                ...
                <p className="text-xl md:text-2xl text-white text-center max-w-2xl">
                  Track, analyze, and improve your fitness with our AI-powered
          ...
          <div className="group relative transform hover:-translate-y-2 transition-all duration-300 h-full">
            ...
            <div className="relative bg-white/30 backdrop-blur-xl rounded-2xl p-6 border border-white/20 shadow-xl overflow-hidden h-full">
              ...
              <div className="relative h-full flex flex-col">
                ...
                <h3 className="text-2xl font-bold text-black mb-4 mt-6">
                  Activity Tracking
                </h3>
                <p className="text-black text-lg flex-1">
                  Track your daily activities, workouts, and progress. Our
                  AI-powered system monitors your fitness metrics and provides
                  real-time insights to help you achieve your goals.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="group relative transform hover:-translate-y-2 transition-all duration-300 h-full">
            ...
            <div className="relative bg-white/30 backdrop-blur-xl rounded-2xl p-6 border border-white/20 shadow-xl overflow-hidden h-full">
              ...
              <div className="relative h-full flex flex-col">
                ...
                <p className="text-black text-lg flex-1">
                  Get detailed insights into your workout performance, calorie
                  burn, and progress over time. Our machine learning algorithms
                  help you understand your fitness patterns and optimize your
                  routine.
                </p>
              </div>
            </div>
          ...
          <div className="group relative transform hover:-translate-y-2 transition-all duration-300 h-full">
            ...
            <div className="relative bg-white/30 backdrop-blur-xl rounded-2xl p-6 border border-white/20 shadow-xl overflow-hidden h-full">
              ...
              <div className="relative h-full flex flex-col">
                ...
                <p className="text-black text-lg flex-1">
                  Receive customized workout recommendations and tips based on
                  your performance and goals. Our AI learns from your fitness
                  data to provide the most effective guidance for you.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto space-y-12">
            <div className="text-center space-y-4">
              ...
              <p className="text-lg text-white">
                Discover your body mass index and take the first step towards a
                healthier you
              </p>
                  ...
                  <div className="text-center w-full">
                    ...
                    <div className="w-full flex flex-col items-center">
                      <div className="relative w-full max-w-2xl h-8 rounded-full overflow-hidden bg-gradient-to-r from-blue-600 via-blue-400 via-green-400 via-yellow-400 to-red-500 shadow-inner">
                        ...
                        ></div>
                        <div
                          className="absolute left-[18.5%] top-0 h-full"
                          style={{
                            width: "7%",
                        ...
                        ></div>
                        <div
                          className="absolute left-[25.5%] top-0 h-full"
                          style={{
                            width: "24.5%",
                        ...
                        ></div>
                        <div
                          className="absolute left-[50%] top-0 h-full"
                          style={{
                            width: "20%",
                        ...
                        ></div>
                        <div
                          className="absolute left-[70%] top-0 h-full"
                          style={{
                            width: "17.5%",
                        ...
                        ></div>
                        <div
                          className="absolute left-[87.5%] top-0 h-full"
                          style={{
                            width: "12.5%",
                        ...
                        {(() => {
                          ...
                          if (bmi < 16) left = (bmi / 16) * 16;
                            ...
                            left = ((bmi - 17) / 1.5) * 7 + 18.5;
                          else if (bmi < 25)
                            left = ((bmi - 18.5) / 6.5) * 24.5 + 25.5;
                          else if (bmi < 30) left = ((bmi - 25) / 5) * 20 + 50;
                          else if (bmi < 35)
                            left = ((bmi - 30) / 5) * 17.5 + 70;
              ...
              <h2
                id="fitness-form"
                className="text-5xl font-bold text-white mt-36"
              >
                Track Your Fitness
              </h2>
              <p className="text-lg text-white">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <div className="space-y-3">
                          <div className="grid grid-cols-3 gap-3">
                            {[
                              ...
                              <button
                                ...
                                type="button"
                                onClick={() =>
                                  setFormData({ ...formData, bmi_class })
                                }
                                className={`px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200 border-2 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent ${
                          ...
                          <div className="grid grid-cols-3 gap-3">
                            {["Over Weight", "Obesity", "Severe Obesity"].map(
                              (bmi_class) => (
                                <button
                                  key={bmi_class}
                                  type="button"
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        <div className="flex justify-between items-center mb-1">
                          ...
                          <span className="text-black text-sm font-medium">
                            {formData.caloriesBurned || "0"} kcal
                          </span>
                        </div>
                        <div className="overflow-hidden h-1.5 rounded bg-[#86C1FF]/20">
                          <div
                  ...
                  <div className="bg-white/5 backdrop-blur-xl p-6 rounded-2xl border border-[#86C1FF]/30">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-[#86C1FF] font-medium">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-black/60 text-sm">
                            Based on your heart rate data, consider adding more
                            cardio exercises
                          </p>
                        </div>
                      </div>
                      {showTip && (
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            <p className="text-black/60 text-sm">
                              You're on track to reach your weekly activity
                              target
                            </p>
                          </div>
                        </div>
